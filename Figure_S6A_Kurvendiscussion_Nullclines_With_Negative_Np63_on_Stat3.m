...
scatter(0, PKC/d_Stat3, 100, 'm','Filled')
...
figure
plot(Np63_t, Stat_Nullcline(IL4, PKC, Np63_t, v_Np63, d_Stat3, nu), 'Color','r','LineWidth',3)
hold on
xlabel('Np63(t)');
plot(Np63_t, Np63_t_Nullcline(beta, alpha,n_H,k_Np63,Np63_t), 'Color','b','LineWidth',3)

ylabel('Nullcines');
hold on
axis square

line([0, 10], [v_Np63/nu, v_Np63/nu], 'Color','c','LineStyle', ':','LineWidth',2)
text(10, v_Np63/nu, ' v_N_p_6_3/\nu', 'Color','c');%, 'FontSize',20)

scatter(-mu/(-beta-1/beta),-beta*mu/(-beta-1/beta), 50, 'k')
text(-mu/(-beta-1/beta),-beta*mu/(-beta-1/beta), ' A', 'Color','b', 'FontSize',10)

scatter(0, PKC/d_Stat3, 100, 'm','Filled')
text(0, PKC/d_Stat3, ' PKC/d_S_t_a_t_3', 'Color','m', 'FontSize',10)

%syms beta x k_Np63 alpha
scatter((-mu-alpha)/(-beta-1/beta),(alpha/beta-beta*mu)/(-beta-1/beta), 50, 'k')
text((-mu-alpha)/(-beta-1/beta),(alpha/beta-beta*mu)/(-beta-1/beta), ' B', 'Color','b', 'FontSize',10)
