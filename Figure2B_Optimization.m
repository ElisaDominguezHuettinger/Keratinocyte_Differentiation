...
%%  Parameters - initial guess. We know that with this parameter set the model displays bistability
...
CostFunction_Keratinocytes_INT(x0,t_exp,data, y0, tspan, PKC,NFkB, IL4, v_Np63,va_Np63, d_Stat3, k_Np63, n_H, v_Stat3, d_Np63,d_PKC, aux_1, aux_2);


min=@(x)CostFunction_Keratinocytes_INT(x,t_exp,data, y0, tspan, PKC,NFkB, IL4, v_Np63,va_Np63, d_Stat3, k_Np63, n_H, v_Stat3, d_Np63,d_PKC, aux_1, aux_2);
